...
**Umgesetzt:**
- **Discovery:** ARG-Abfrage Q-PAAS über 52 PaaS-Diensttypen (`src/models/paasCatalog.ts`) plus ARM-Enrichment E-PAAS-01…03 für SQL-/Flexible-Server-Firewall und App-Service-Zugriffsbeschränkungen.
